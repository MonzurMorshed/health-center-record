		...
		if($_FILES["file"]["size"] > 0)
		{
	        ...
	        while (($getData = fgetcsv($file, 10000, ",")) !== FALSE)
			{
                ...
                values (
					...
					'".$getData[104]."','".$getData[105]."','".$getData[106]."','".$getData[107]."','".$getData[108]."'
				)  
				...
				'".$getData[104]."',docyor_qualification='".$getData[105]."',Added_on='".$getData[106]."',surgeonName='".$getData[107]."',surgeonQualifications='".$getData[108]."'
				";
