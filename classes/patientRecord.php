<?php
	...
	class patientRecord extends errorClass
	{
		...
		public function patient_details($condition)
		{
			global $db;			
		...
		public function addUpdatePatientRecord($patient_id=0)
		{
			...
			if($patient_id <= 0)
			{
				$this->sql			= "INSERT INTO patient_record (
									...
									".$db->ToSQL($this->surgeonName,'Text').",
									".$db->ToSQL($this->surgeonQualifications,'Text')."
									)";
				$db->executeQuery($this->sql);
			}
			else
			{
				$this->sql			="UPDATE patient_record SET 
									...
									surgeonName 					= ".$db->ToSQL($this->surgeonName,'Text').",
									surgeonQualifications 			= ".$db->ToSQL($this->surgeonQualifications,'Text')."
