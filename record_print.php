        ...
        <div id="report">
        	<form action="" method="get" class="niceform">
                <div id="checkType">
                    ...
                    <strong>Checkup Type: </strong>&nbsp;<?php if ($ObjPatientRecord->checkup_type == "pre")
{
    echo "Pre-employment";
}
else
{
    echo ucfirst($ObjPatientRecord->checkup_type);
} ?> 
                    </div>
                    
                    <div style="float:right;"><strong>Company Name: </strong>&nbsp;<span class="company"><?php echo $ObjPatientRecord->company_name; ?></span></div>
               </div>
                        ...
                        <div class="box_container">
                        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td><?php if ($ObjPatientRecord->patient_sex == "M")
{
    echo "Male";
}
else
{
    echo "Female";
                              ...
                              <tr>
                                ...
                                <td><?php if ($ObjPatientRecord->mariatal_status == "Y")
{
    echo "Married";
}
else
...
?>
            ...
            <br />
                    ...
                    <div class="box_container result">
                            ...
                            <label><?php if ($ObjPatientRecord->medical_fitness == "Y")
{
    echo "FIT";
}
else
{
    echo "UNFIT";
                    ...
                    <div class="box_container doctor2">
                        	<strong>Authorized Certifying Surgeon:</strong> <?php echo "Dr. " . ucfirst($ObjPatientRecord->surgeonName); ?>, <?php echo $ObjPatientRecord->surgeonQualifications ?>
         			</div>
